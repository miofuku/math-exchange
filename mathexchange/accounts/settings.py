...
MIDDLEWARE += [
    #'mathexchange.accounts.middleware.limiter',
]
...
ACCOUNT_EMAIL_SUBJECT_PREFIX = "[mathexchange. "
...
ACCOUNTS_APPS = [
    ...
    'mathexchange.accounts.apps.AccountsConfig',
...
ROOT_URLCONF = 'mathexchange.accounts.urls'
