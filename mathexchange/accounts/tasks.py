...
from mathexchange.utils.decorators import task
...
def verification_email(user_id):
    from mathexchange.accounts import auth, models
...
def create_messages(template, user_ids, sender=None, extra_context={}):
    ...
    """
    from mathexchange.accounts.models import User, Message, MessageBody
