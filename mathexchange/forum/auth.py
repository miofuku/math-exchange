...
from mathexchange.accounts.const import MESSAGE_COUNT
from mathexchange.accounts.models import Message
...
from mathexchange.utils.helpers import get_ip
...
def gravatar(user, size=80):
    if not user or user.is_anonymous:
        email = 'anon@mathexchange.org'.encode('utf8')
    ...
    if user.is_anonymous or not user.profile.is_valid:
        ...
        email = 'suspended@mathexchange.org'.encode('utf8')
        style = "monsterid"
