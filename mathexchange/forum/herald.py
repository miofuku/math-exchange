...
from mathexchange.planet.models import Blog, BlogPost
from django.db.models import F
from mathexchange.forum import auth, util
from mathexchange.forum.models import Post, SharedLink
from mathexchange.emailer.models import EmailGroup, EmailSubscription
from mathexchange.utils.decorators import is_moderator, authenticated
from mathexchange.forum.tasks import herald_emails
...
def herald_publisher(request, limit=20, nmin=1):
    ...
    title = f"The MathExchange Herald for {date_fmt}"
