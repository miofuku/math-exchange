...
from mathexchange.planet.settings import *
...
TEMPLATES[0]['OPTIONS']['context_processors'] += [
    'mathexchange.forum.context.forum'
]
...
SOCIALACCOUNT_ADAPTER = "mathexchange.accounts.adapter.SocialAccountAdapter"

FORUM_APPS = [
    'mathexchange.forum.apps.ForumConfig',
]
...
MIDDLEWARE += [
    #'mathexchange.forum.middleware.ban_ip',
    'mathexchange.forum.middleware.user_tasks',
    'mathexchange.forum.middleware.benchmark',
]
...
ROOT_URLCONF = 'mathexchange.forum.urls'

WSGI_APPLICATION = 'mathexchange.wsgi.application'
...
DROPDOWN_TAGS = False
TASK_MODULES = ("mathexchange.forum.tasks", )
