...
from mathexchange.forum import models, views, auth, forms, const, ajax
from mathexchange.utils.helpers import fake_request
from mathexchange.forum.util import get_uuid
...
class PostTest(TestCase):
    ...
    @patch('mathexchange.forum.models.Post.save', MagicMock(name="save"))
