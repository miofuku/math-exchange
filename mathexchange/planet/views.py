...
def mathexchange_herald():
    blog, created = Blog.objects.get_or_create(title="MathExchange Herald",
                                               desc="Share mathematics resources from across the web.", remote=False)
    return blog
