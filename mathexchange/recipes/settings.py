...
TASK_MODULES = ("mathexchange.recipes.tasks",)
...
ENGINE_APPS = [
    'mathexchange.recipes.apps.EngineConfig',
...
MIDDLEWARE += [
    'mathexchange.recipes.middleware.recipes_middleware',
]

# The URL configuration.
ROOT_URLCONF = 'mathexchange.recipes.urls'

# Add another context processor to first template.
TEMPLATES[0]['OPTIONS']['context_processors'] += [
    'mathexchange.recipes.context.engine'
]
