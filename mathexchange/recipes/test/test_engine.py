...
from mathexchange.recipes import models, views, auth, factory, forms, const, api
from mathexchange.recipes import util as engine_util
...
class SiteAdminTest(TestCase):
    ...
    def test_site_admin(self):
        ...
        # admin page specific to mathexchange.engine.
...
class FactoryTest(TestCase):
    ...
    def test_dynamic_field(self):
        ...
        from mathexchange.recipes import const
...
class UtilTests(TestCase):
    ...
    def test_smart_preview(self):
        ...
        collect = engine_util.findfiles("mathexchange.recipes/test/data", collect=[])
