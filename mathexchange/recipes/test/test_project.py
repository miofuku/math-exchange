...
from mathexchange.recipes import auth
from mathexchange.recipes import models, views, forms, api
...
class ProjectViewTest(TestCase):
    ...
    @patch('mathexchange.recipes.models.Project.save', MagicMock(name="save"))
