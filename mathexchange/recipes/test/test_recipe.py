...
#from mathexchange.accounts.models import Use

from mathexchange.recipes import auth, const
from mathexchange.recipes import models, views, api
from mathexchange.utils.helpers import fake_request, get_uuid
...
class RecipeViewTest(TestCase):
    ...
    @patch('mathexchange.recipes.models.Job.save', MagicMock(name="save"))
    ...
    @patch('mathexchange.recipes.models.Analysis.save', MagicMock(name="save"))
    ...
    def test_recipe_edit(self):
        ...
        from mathexchange.recipes import ajax
