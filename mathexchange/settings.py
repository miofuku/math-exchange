"""
Common settings that are applicable to all mathexchange apps.
"""

import os

# The logging configuration
from mathexchange.logconf import LOGGING
...
# Used during testing
#TEMPLATE_DIRS = [os.path.join(BASE_DIR, 'themes', 'mathexchange')]
...
ROOT_URLCONF = 'mathexchange.urls'
...
STATICFILES_DIRS = [
    join(BASE_DIR, "mathexchange", "static"),
]
